...
class ExtractContactsTests(unittest.TestCase):
    ...
    def test_configured_confidence_is_required(self) -> None:
        self.assertFalse(qualified_company(
            {"status": "outreach_ready", "confidence": ""},
            {"outreach_ready"},
            {"high", "medium"},
        ))
        self.assertTrue(qualified_company(
            {"status": "outreach_ready", "confidence": "medium"},
            {"outreach_ready"},
            {"high", "medium"},
        ))
