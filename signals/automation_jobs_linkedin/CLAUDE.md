...
- Modal volume: `automation-jobs-linkedin-session` (persistent deduplication state only; LinkedIn authentication lives exclusively in the centralized `linkedin-mcp-vol`)
